...
2. The columns of data_train and data_test were labeled using the contents of feat_tab.  
...
5. | fBodyAccMag-std()  
6. | fBodyBodyAccJerkMag-std()   
7. | fBodyBodyGyroMag-std()  
8. | fBodyBodyGyroJerkMag-std()  
...
2.  The Test and Train data frames were then formed by combining the results of step 1 with the sub and act dataframes created during the earlier creation and cleansing step.  
