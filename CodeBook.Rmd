...
##Processing Steps
In cleansing and preparing data for analysis, the process is documented in the script run_analysis.R and outlined in the following steps:  
...
## Process Script
The steps required to perform this transformation are provided in the R Program script entitled run_analysis.R.  
